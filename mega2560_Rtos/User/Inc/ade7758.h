...
#define DIV 2//Register address//Register address
...
6					SWRST				0					Software Chip Reset. A data transfer to the ADE7758 should not take place for at least 18 ?s after a software reset.
